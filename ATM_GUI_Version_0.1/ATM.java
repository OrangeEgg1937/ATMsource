...
public class ATM                                                         
{
   ...
   {
      screen.displayMessage( "Please login first" );
      keypad.loginHandle();
      int accountNumber = keypad.input1;
      int pin = keypad.input2;
   ...
   private int displayMainMenu()                                                
   {
      ...
      screen.displayMessage( "3 - Transfer funds" );                        
      screen.displayMessage( "4 - Exit" );                                
      screen.displayMessage( "Enter a choice: " );            

      return keypad.getInput("Enter a choice: "); // return user's selection
